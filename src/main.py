...
def menu_liste():
    def liste_sportifs():
        label_sportifs = tk.Label(cadre3, text="Liste des sportifs :", font=("Berlin Sans FB", 20), bg='lightgray', fg ='darkgreen')
        label_sportifs.pack()
    def liste_disciplines():
        label_discipline = tk.Label(cadre3, text="Liste des disciplines :", font=("Berlin Sans FB", 20), bg='lightgray', fg ='darkgreen')
        label_discipline.pack()
    bouton_sportifs = tk.Button(cadre2,cursor='hand2', text="Sportifs", font=("Courrier", 12), width=12,bg='gray', fg='black', command=liste_sportifs)
    bouton_sportifs.pack()
    bouton_disciplines = tk.Button(cadre2,cursor='hand2', text="Disciplines", font=("Courrier", 12),width=12, bg='gray', fg='black', command=liste_disciplines)
    bouton_disciplines.pack()
    bouton_gerer_sportifs = tk.Button(cadre2,cursor='hand2', text="Gérer les sportifs", font=("Courrier", 10),width=12, bg='lightgreen', fg='black', command=test_liste)
...
def test_liste():
    ...
    entry.pack()
    bouton_afficher2 = tk.Button(cadre3, text="Chercher", command=test_chercher, font=("Georgia", 12), bg='lightgreen', fg ='black', cursor='hand2')
